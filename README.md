...
- `java/` — Java library published to Maven Central (`com.optivem:optivem-testing`)
- `dotnet/` — .NET library published to NuGet (`Optivem.Testing`)
- `typescript/` — TypeScript library published to npm (`@optivem/optivem-testing`)
